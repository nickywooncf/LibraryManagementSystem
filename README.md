...
[.NET 6.0 SDK or higher] (Update this to match the version you used)
Visual Studio 2022 (or VS Code with C# Dev Kit)

How to Run the Project Locally
Clone the repository to your local machine.
Open the .sln file in Visual Studio.
Press F5 (or run dotnet run via CLI) to build and launch the application.

The application will automatically launch the Swagger UI in your default web browser, allowing you to execute API requests and test the library operations directly.
